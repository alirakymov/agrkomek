...
return [
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(Notification);data)' => [
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(Notification);title)' => [
        'iSynapse' => 'QSynapse:Synapses(Notification)',
        'name' => 'title',
        'label' => 'Заголовок',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\Text',
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(NotificationMessage);event)' => [
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(NotificationMessage);messageKz)' => [
        'iSynapse' => 'QSynapse:Synapses(NotificationMessage)',
        'name' => 'messageKz',
        'label' => 'Сообщение на казахском',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\Text',
        'description' => 'Сообщение на казахском',
    ],
    'QSynapse:SynapseAttributes(QSynapse:Synapses(NotificationMessage);messageRu)' => [
        'iSynapse' => 'QSynapse:Synapses(NotificationMessage)',
        'name' => 'messageRu',
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(NotificationMessage);titleKz)' => [
        'iSynapse' => 'QSynapse:Synapses(NotificationMessage)',
        'name' => 'titleKz',
        'label' => 'Заголовок на казахском',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\Text',
        'description' => 'Заголовок на казахском',
    ],
    'QSynapse:SynapseAttributes(QSynapse:Synapses(NotificationMessage);titleRu)' => [
        'iSynapse' => 'QSynapse:Synapses(NotificationMessage)',
        'name' => 'titleRu',
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(Story);images)' => [
        'iSynapse' => 'QSynapse:Synapses(Story)',
        'name' => 'images',
        'label' => 'Изображения',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\LongText',
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(Story);link)' => [
        'iSynapse' => 'QSynapse:Synapses(Story)',
        'name' => 'link',
        'label' => 'Ссылка',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\VarcharBig',
    ...
    'QSynapse:SynapseAttributes(QSynapse:Synapses(Story);title)' => [
        'iSynapse' => 'QSynapse:Synapses(Story)',
        'name' => 'title',
        'label' => 'Заголовок',
        'type' => 'Qore\\ORM\\Mapper\\Table\\Column\\VarcharBig',
