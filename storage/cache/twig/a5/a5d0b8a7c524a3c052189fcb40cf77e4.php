...
/* @app/login.twig */
class __TwigTemplate_bff473e76509a598e9c08d916743c4f4 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@layout/main.twig", "@app/login.twig", 1);
...
{% block scripts %}
    ...
    {{ parent() }}
{% endblock %}
", "@app/login.twig", "/usr/share/nginx/agro/frontapp/gateway/public/templates/desk/app/login.twig");
    }
}
