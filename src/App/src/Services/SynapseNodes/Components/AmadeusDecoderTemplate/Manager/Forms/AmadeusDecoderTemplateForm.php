...
namespace Qore\App\SynapseNodes\Components\AmadeusDecoderTemplate\Manager\Forms;
...
/**
 * Class: AmadeusDecoderTemplateForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class AmadeusDecoderTemplateForm extends FormArtificer
{
    /**
     * subscribe
     *
