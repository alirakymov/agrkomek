...
namespace Qore\App\SynapseNodes\Components\UserGroup\Manager;
 ...
 */
class UserGroupService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'UserGroupForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/user-group', null, function($_router) {
