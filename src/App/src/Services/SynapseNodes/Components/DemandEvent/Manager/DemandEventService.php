...
namespace Qore\App\SynapseNodes\Components\DemandEvent\Manager;
 ...
 */
class DemandEventService extends ServiceArtificer
{
    /**
     * sortable
     *
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/demand-event', null, function($_router) {
