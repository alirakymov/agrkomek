...
namespace Qore\App\SynapseNodes\Components\DemandStatus\Manager;
 ...
 */
class DemandStatusService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'DemandStatusForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/demand-status', null, function($_router) {
    ...
    protected function getComponent($_data = null)
    {
        if ($_data === true) {
            ...
            $_data = $this->mm('SM:DemandStatus')->all();
    ...
    protected function getCount() : int
    {
        ...
        return (int)$this->mm('SM:DemandStatus')->select(function($_select) {
