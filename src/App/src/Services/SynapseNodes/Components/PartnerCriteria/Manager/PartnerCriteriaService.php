...
namespace Qore\App\SynapseNodes\Components\PartnerCriteria\Manager;
...
/**
 * Class: PartnerCriteriaService
 *
 * @see Qore\SynapseManager\Artificer\Service\ServiceArtificer
 */
class PartnerCriteriaService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'PartnerCriteriasForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/partner-criteria', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Сервис - Сервис проверки валидности почты по критериям',
