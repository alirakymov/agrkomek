...
namespace Qore\App\SynapseNodes\Components\AmadeusGlossaryItem\Manager\Forms;
...
/**
 * Class: AmadeusGlossaryItemForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class AmadeusGlossaryItemForm extends FormArtificer
{
    /**
     * subscribe
     *
