...
namespace Qore\App\SynapseNodes\Components\TelegramBot\Manager;
 ...
 */
class TelegramBotService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'TelegramBotForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/telegram-bot', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление Telegram-ботами - Сервис управления Telegram-ботами',
