...
namespace Qore\App\SynapseNodes\Components\OutboxPartnerEmail\Manager\Forms;
...
/**
 * Class: OutboxPartnerEmailForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class OutboxPartnerEmailForm extends FormArtificer
{
    /**
     * subscribe
     *
