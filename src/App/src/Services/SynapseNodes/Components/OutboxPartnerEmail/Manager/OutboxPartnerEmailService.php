...
namespace Qore\App\SynapseNodes\Components\OutboxPartnerEmail\Manager;
...
/**
 * Class: OutboxPartnerEmailService
 *
 * @see Qore\SynapseManager\Artificer\Service\ServiceArtificer
 */
class OutboxPartnerEmailService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'OutboxPartnerEmailForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/outbox-partner-email', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Сервис - Управление почтой отправителя',
