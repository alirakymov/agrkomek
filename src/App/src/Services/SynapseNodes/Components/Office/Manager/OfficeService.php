...
namespace Qore\App\SynapseNodes\Components\Office\Manager;
...
class OfficeService extends ServiceArtificer
{
     ...
     * @var string
     */
    private $serviceForm = 'OfficeForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/office', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление офисом - Управление офисом',
