...
namespace Qore\App\SynapseNodes\Components\AmadeusDecoderPattern\Manager\Forms;
...
/**
 * Class: AmadeusDecoderPatternForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class AmadeusDecoderPatternForm extends FormArtificer
{
    /**
     * subscribe
     *
