...
namespace Qore\App\SynapseNodes\Components\DemandMessage\Manager;
...
/**
 * Class: DemandMessageService
 *
 * @see Qore\SynapseManager\Artificer\Service\ServiceArtificer
 */
class DemandMessageService extends ServiceArtificer
{
    /**
     * sortable
     *
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/demand-message', null, function($_router) {
            ...
            'columns' => [
                ...
                'body' => [
                    ...
                    'transform' => function($_item) {
                        return implode(' ', array_slice(array_filter(explode(' ', strip_tags($_item['body']))), 0, 20));
                    }
                ],
                'messageDate' => [
                    'label' => 'Дата получсения',
                    'class-header' => 'col-2',
                    'class-column' => 'col-2',
                ]
            ],
