...
use Qore\App\SynapseNodes\Components\User\Register\Plugin\Operation\VerifyPhone; use Qore\App\SynapseNodes\Components\User\User;
...
use Qore\SessionManager\SessionContainer;
use Qore\SessionManager\SessionManager;
use Qore\SessionManager\SessionManagerFactory;
 ...
 */
class ModeratorService extends ServiceArtificer implements PhoneVerifiableInterface
{
    ...
    protected function index() : ?ResultInterface
    {
        ...
        $artificer = ($this->sm)('EducationPlatform:Executor');
