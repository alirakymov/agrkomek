...
namespace Qore\App\SynapseNodes\Components\Moderator\Manager;
 ...
 */
class ModeratorService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'ModeratorForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/moderator', null, function($_router) {
        ...
        return [
            'resetPassword' => [
                ...
                'confirm' => function($_data) {
                    return [
                        'title' => 'Сброс пароля',
                        'message' => sprintf('Точно сбрасываем пароль модератору "%s"?', $_data['email'] ?? $_data['title'] ?? $_data->id)
                    ];
                },
            ],
            'update', 'delete',
