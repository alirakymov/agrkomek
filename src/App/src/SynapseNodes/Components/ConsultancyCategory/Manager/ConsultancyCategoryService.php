...
namespace Qore\App\SynapseNodes\Components\ConsultancyCategory\Manager;
...
/**
 * Class: ConsultancyCategoryService
 *
 * @see Qore\SynapseManager\Artificer\Service\ServiceArtificer
 */
class ConsultancyCategoryService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'ConsultancyCategoryForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/consultancy-category', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление категориями консультаций - ',
