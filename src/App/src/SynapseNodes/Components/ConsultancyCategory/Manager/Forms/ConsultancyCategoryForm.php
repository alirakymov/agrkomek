...
namespace Qore\App\SynapseNodes\Components\ConsultancyCategory\Manager\Forms;
...
/**
 * Class: ConsultancyCategoryForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class ConsultancyCategoryForm extends FormArtificer
{
    /**
     * subscribe
     *
