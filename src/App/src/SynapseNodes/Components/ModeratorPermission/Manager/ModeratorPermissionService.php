...
namespace Qore\App\SynapseNodes\Components\ModeratorPermission\Manager;
 ...
 */
class ModeratorPermissionService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'ModeratorPermission';
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление правами ролей - Управление правами ролей',
            ...
            'columns' => [
                ...
                'component' => [
                    ...
                    'transform' => function ($_item) {
                        $components = ModeratorPermission::getComponents();
                        foreach ($components as $component) {
                            if ($component['id'] == $_item['component']) {
                ...
                'level' => [
                    ...
                    'class-column' => 'col-2',
                    'transform' => function ($_item) {
                        $levels = ModeratorPermission::getLevels();
                        foreach ($levels as $level) {
                            if ($level['id'] == $_item['level']) {
                                return $level['label'];
                            }
                        }
                    },
