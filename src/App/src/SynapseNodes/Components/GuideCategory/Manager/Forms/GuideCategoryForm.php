...
namespace Qore\App\SynapseNodes\Components\GuideCategory\Manager\Forms;

use Qore\App\SynapseNodes\Components\GuideCategory\GuideCategory;
 ...
 */
class GuideCategoryForm extends FormArtificer
{
    /**
     * subscribe
     *
    ...
    public function subscribe(EventManager $_em)
    {
        ...
        if ($languageField) {
            ...
            $_em->attach($languageField->getFieldEventName($this, 'init.after', self::LCL), function ($_event) {
                ...
                $options = Qore::collection(GuideCategory::getLanguages());
