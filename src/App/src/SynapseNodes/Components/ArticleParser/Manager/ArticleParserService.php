...
namespace Qore\App\SynapseNodes\Components\ArticleParser\Manager;
 ...
 */
class ArticleParserService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'ArticleParserForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/article-parser', null, function($_router) {
