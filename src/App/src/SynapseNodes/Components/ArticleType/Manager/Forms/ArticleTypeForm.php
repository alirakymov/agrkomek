...
namespace Qore\App\SynapseNodes\Components\ArticleType\Manager\Forms;

use Qore\App\SynapseNodes\Components\ArticleType\ArticleType;
...
/**
 * Class: ArticleTypeForm
 *
 * @see Qore\SynapseManager\Artificer\Form\FormArtificer
 */
class ArticleTypeForm extends FormArtificer
{
    /**
     * subscribe
     *
    ...
    public function subscribe(EventManager $_em)
    {
        ...
        if ($languageField) {
            ...
            $_em->attach($languageField->getFieldEventName($this, 'init.after', self::LCL), function ($_event) {
                ...
                $options = Qore::collection(ArticleType::getLanguages());
