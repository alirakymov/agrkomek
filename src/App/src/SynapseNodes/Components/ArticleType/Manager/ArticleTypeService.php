...
namespace Qore\App\SynapseNodes\Components\ArticleType\Manager;
...
class ArticleTypeService extends ServiceArtificer
{
     ...
     * @var string
     */
    private $serviceForm = 'ArticleTypeForm';
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление типами новостей - Управление типами новостей',
