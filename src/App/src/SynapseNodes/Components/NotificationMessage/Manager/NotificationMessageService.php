...
namespace Qore\App\SynapseNodes\Components\NotificationMessage\Manager;
 ...
 */
class NotificationMessageService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'NotificationMessage';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/notification-message', null, function($_router) {
    ...
    protected function index($_reload = false)
    {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            return $this->response(new HtmlResponse(Qore::service(TemplateRendererInterface::class)->render('app::main', [
                'title' => 'Управление сообщениями - Управление сообщениями',
