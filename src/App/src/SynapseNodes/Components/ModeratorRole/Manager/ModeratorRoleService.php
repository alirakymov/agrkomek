...
namespace Qore\App\SynapseNodes\Components\ModeratorRole\Manager;
...
/**
 * Class: ModeratorRoleService
 *
 * @see Qore\SynapseManager\Artificer\Service\ServiceArtificer
 */
class ModeratorRoleService extends ServiceArtificer
{
    /**
     * sortable
     *
     ...
     * @var string
     */
    private $serviceForm = 'ModeratorRoleForm';
    ...
    public function routes(RouteCollector $_router) : void
    {
        ...
        $_router->group('/moderator-role', null, function($_router) {
        ...
        return [
            'permissions' => [
                ...
                'actionUri' => function($_data) {
                    $artificer = $this->sm('ModeratorPermission:Manager');
