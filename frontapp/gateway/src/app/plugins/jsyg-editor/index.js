(function(factory) {
    ...
    module.exports = factory(
        require("./jsyg-lib/jsyg"),
        require("./jsyg-lib/jsyg.editor"),
        require("./jsyg-lib/jsyg.texteditor"),
        require("./jsyg-lib/jsyg.zoomandpan"),
        require("./jsyg-lib/jsyg.pathdrawer"),
        require("./jsyg-lib/jsyg.polylinedrawer"),
        require("./jsyg-lib/jsyg.shapedrawer"),
        require("./jsyg-lib/jsyg.undoredo"),
        require('hotkeys-js').default
    );

})(function(JSYG,Editor,TextEditor,ZoomAndPan,PathDrawer,PolylineDrawer,ShapeDrawer,UndoRedo, hotkeys) {
