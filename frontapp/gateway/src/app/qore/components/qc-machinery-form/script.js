...
import {YandexMap, YandexMapDefaultSchemeLayer, YandexMapMarker, YandexMapListener, YandexMapDefaultFeaturesLayer} from 'vue-yandex-maps';
/** Lodash ES */
...
export default {
    ...
    components: { YandexMap, YandexMapDefaultSchemeLayer, YandexMapMarker, YandexMapListener, YandexMapDefaultFeaturesLayer},


    data: function() {
        let center = [48.352571497155054, 64.04235076905002], machinery = _.get(this.options, 'machinery', null);

        if (machinery.lat && machinery.lon) {
            center = [machinery.lat, machinery.lon];
        }
        return {
    ...
    computed: {
        ...
        marker() {
            return {
                coordinates: [this.machinery.lat, this.machinery.lon],
                title: 'blue color',
    ...
    methods: {
        ...
        clickOnMap() {
            return (b, e) => {
                ...
                this.machinery.lat = e.coordinates[0];
                this.machinery.lon = e.coordinates[1];
            }
        },
